...
<span className='rounded-full w-6 h-6  text-center text-sm font-semibold  border'>AI</span>
              ...
              </div> : (chat.question ? <div className='flex items-center gap-2'>
 ...
 <div className='bg-white flex flex-col justify-start text-black w-fit p-2 rounded-md'>
                 <span className='text-lg font-semibold'>
                  ...
                  <span className='text-sm text-gray-500'>
                    {chat.answer.sectionName ? `Section: ${chat.answer.sectionName}` : ""}
                    </span>
                    
                    <span className='text-sm text-gray-500'>
                    {chat.answer.matchScore ? `Match Score: ${chat.answer.matchScore}` : ""}
                    </span>
